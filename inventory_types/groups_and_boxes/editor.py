...
class GroupsAndBoxesEditor(QWidget):
    ...
    def __init__(self, sig_master: GroupsAndBoxesSignalMaster, *args, **kw):
        ...
        self._box = None  ## A reference to the current box object
        self._group = None  ## A reference to the current group object
        self._editorState = GroupsAndBoxesEditorMode.EMPTY  ## The current state of the editor: BOX, GROUP, EMPTY

        self._signal_master = sig_master  ## A reference to the signal master for this inventory
